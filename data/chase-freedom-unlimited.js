// Chase Freedom Unlimited® Credit Card data
(function() {
  const terms = {
    ...
    "5% on Chase Travel": `5% Cash Back: You'll earn 5% Cash Back rewards total for each $1 spent on purchases made using your card through Chase Travel (3.5% additional Cash Back rewards on top of the 1.5% Cash Back rewards earned on each purchase).`,

    "3% on Dining": `3% Cash Back on Dining: You'll earn 3% Cash Back rewards total for each $1 spent on purchases in the dining at restaurants category including takeout and eligible delivery services (1.5% additional Cash Back rewards on top of the 1.5% Cash Back rewards earned on each purchase).`,

    "3% on Drugstores": `3% Cash Back on Drugstores: You'll earn 3% Cash Back rewards total for each $1 spent on purchases in the drugstores category (1.5% additional Cash Back rewards on top of the 1.5% Cash Back rewards earned on each purchase).`,

    "1.5% on Everything Else": `1.5% Cash Back: You'll earn 1.5% Cash Back rewards for each $1 spent. Points don't expire as long as your account remains open. Merchants who accept Visa/Mastercard credit cards are assigned a merchant code, which is determined by the merchant or its processor in accordance with Visa/Mastercard procedures based on the kinds of products and services they primarily sell. Purchases submitted through third-party payment accounts, mobile or wireless card readers, online or mobile digital wallets, or similar technology will not qualify in a rewards category if the technology is not set up to process the purchase in that rewards category.`,
  ...
  const benefits = [
    ...
    // Earning Potential
    { section: "Earning Potential (annual estimate)", name: "5% on Chase Travel", desc: "5 UR pts/$1 on travel purchased through Chase Travel. Estimate annual points value.", min: 0, max: 500, default: 0 },
    ...
    { name: "1.5% on Everything Else", desc: "1.5 UR pts/$1 on all other purchases, no cap. Estimate annual points value.", min: 0, max: 1000, default: 0, comment: "Points value depends on redemption: 1¢ cash back, 1.25¢ via Sapphire Preferred travel, 1.5¢ via Sapphire Reserve travel, or transfer to partners for potentially more." },
  ...
  const card = {
    ...
    detailUrl: 'chase-freedom-unlimited.html',
