// Amazon Visa (Amazon Rewards Visa Signature Card) data
(function() {
  const terms = {
    "$50 Amazon Gift Card": `Get a $50 Amazon Gift Card instantly loaded into your Amazon account's Gift Card Balance on approval of your credit card application. This credit card is available to you if you do not currently have an Amazon Visa or Prime Visa credit card. The Gift Card is only awarded to new cardmembers and at the time of card approval. The Gift Card cannot be used for other gift card purchases. Amazon.com Gift Cards are issued by ACI Gift Cards, Inc., a Washington company.`,

    "3% Back at Amazon & Whole Foods": `You'll earn 3% back without an eligible Prime membership for each $1 of eligible purchases made using your card account at Amazon.com (including digital downloads, Amazon.com Gift Cards, Amazon Fresh orders, Amazon Prime subscriptions, and items sold by third-party merchants through Amazon.com's marketplace), Audible.com, Whole Foods Market locations in the United States, and the participating Amazon stores and sites. 3% back equates to $0.03 for each $1 spent (3 points). Not earned on purchases made via Amazon Pay, at international Amazon retail sites, or at international Whole Foods Markets. If you have an eligible Prime membership, purchases instead earn 5% back.`,

    "3% Back on Chase Travel": `You'll earn 3% back without an eligible Prime membership for each $1 spent on purchases made using your card account through Chase Travel. 3% back is not earned on purchases made directly with travel suppliers including airline, hotel, car rentals and cruises.`,
  ...
  const benefits = [
    ...
    { section: "Sign-On Bonus (First Year Only)", name: "$50 Amazon Gift Card", desc: "$50 Amazon Gift Card loaded instantly on approval. No Prime membership required.", min: 0, max: 50, default: 47.5, firstYearOnly: true },

    // Earning Potential (annual estimate)
    { section: "Earning Potential (annual estimate)", name: "3% Back at Amazon & Whole Foods", desc: "3% back at Amazon.com, Audible, and Whole Foods Market (no Prime required). Estimate annual dollar value earned.", min: 0, max: 600, default: 0, comment: "No Prime membership required. With an eligible Prime membership these purchases instead earn 5% — consider the Prime Visa if you're a Prime member." },
    { name: "3% Back on Chase Travel", desc: "3% back on travel booked through Chase Travel. Estimate annual dollar value earned.", min: 0, max: 300, default: 0 },
  ...
  const card = {
    id: 'chase-amazon-visa',
    detailUrl: 'chase-amazon-visa.html',
    name: 'Amazon Visa',
    issuer: 'Chase',
    ...
    annualFee: 0,
    signOnBonusLabel: '$50 Amazon Gift Card',
    benefits: benefits,
    terms: terms,
  };
